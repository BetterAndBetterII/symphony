...
This directory contains the Elixir agent orchestration service that polls the configured issue tracker (GitHub Projects by default), creates per-issue workspaces, and runs Codex in app-server mode.
