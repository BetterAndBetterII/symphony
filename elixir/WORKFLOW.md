...
## Prerequisite: GitHub auth or `github_graphql` tool is available

The agent should be able to talk to GitHub (via a PAT/`GITHUB_TOKEN`/`GH_TOKEN`) and/or via the injected `github_graphql` tool. If none are present, stop and ask the user to configure GitHub auth.
